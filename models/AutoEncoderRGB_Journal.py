...
from layers.TransformRGB import Analysis_transform,Synthesis_transform
...
def reconstruct_error(input,output,input_mask,output_mask):
    ...
    """
    reconstruction_error = F.mse_loss(img1_masked[input_mask_one > 0],img2_masked[input_mask_one > 0],reduction='mean')
    """
...
class AutoEncoder(CompressionModel):
    ...
    def forward(self, input,mask,reconmask,me1,me2,me3,me4):    
        ...
        #     pass
        # else:
        #     torchvision.utils.save_image(y[:,0:1,:,:], "heatmap.png")
        y_shape = y.shape[2:]
        z = self.h_a(y)
    ...
    def decompress(self, strings, shape,mask):
        ...
        y_shape = [z_hat.shape[2] * 8, z_hat.shape[3] * 8]
